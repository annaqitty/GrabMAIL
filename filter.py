...
"gianteagle.com": "Giant Eagle Family",
    "cebridge.net": "CeBridge Family",
    "cox.net": "Cox Family",
    "centurylink.net": "CenturyLink Family",
    "q.com": "Qwest Family",
    "atlanticbb.net": "Atlantic Broadband Family",
    "mchsi.com": "Mediacom Family",
    "esselunga.it": "Esselunga Family",
    "bell.ca": "Bell Canada Family",
    "sympatico.ca": "Bell Canada Family",
    "comcast.net": "Comcast Family",
    "abv.bg": "ABV Bulgaria Family",
    "libero.it": "Libero Family",
    "outlook.com": "Microsoft Family",
    "msn.com": "Microsoft Family",
    "live.com": "Microsoft Family",
    "hotmail.it": "Microsoft Family",
    "live.it": "Microsoft Family",
    "virgilio.it": "Virgilio Family",
    "hotmail": "Microsoft Family",
    "suddenlink.net": "Suddenlink Family",
    "optonline.net": "Optimum Family",
    "tiscali.co.uk": "TalkTalk Family",
    "netzero.net": "United Online Family",
    "netzero.com": "United Online Family",
    "juno.com": "United Online Family",
    "bigpound.com": "Bigpond Family",
    "triad.rr.com": "Road Runner Family",
    "carolina.rr.com": "Road Runner Family",
    "rr.com": "Road Runner Family",
    "nc.rr.com": "Road Runner Family",
    "sc.rr.com": "Road Runner Family",
    "orange.fr": "Orange Family",
    "wanadoo.fr": "Orange Family",
    "neuf.fr": "SFR Family",
    "sfr.fr": "SFR Family",
    "op.pl": "Orange Poland Family",
    "o2.pl": "O2 Poland Family",
    "onet.pl": "Onet Family",
    "wp.pl": "Wirtualna Polska Family",
    "videotron.ca": "Videotron Family",
    "shaw.ca": "Shaw Family",
    "bellnet.ca": "Bell Canada Family",
    "cogeco.ca": "Cogeco Family",
    "uol.com.br": "UOL Family",
    "bol.com.br": "BOL Family",
    "roadrunner.com": "Road Runner Family",
    "ntlworld.com": "Virgin Media Family",
    "optimum.net": "Optimum Family",
    "blueyonder.co.uk": "Virgin Media Family",
    "twc.com": "Time Warner Cable Family",
    "zoominternet.net": "Zoom Internet Family",
    "charter.net": "Spectrum Family",
    "hawaiiantel.net": "Hawaiian Telcom Family",
    "frontier.com": "Frontier Family",
    "earthlink.net": "EarthLink Family",
    "windstream.net": "Windstream Family",
    
    # European ISPs & Regional Giants
    ...
    "ntlworld.com": "Virgin Media Family",
    "sky.com": "Sky Family",
    "tesco.net": "Tesco Family",
    "o2.co.uk": "O2 Family",
    "orange.net": "Orange UK Family",
    "freenet.de": "Freenet Family",
    "t-online.de": "Telekom Family",
    "mail.de": "Mail.de Family",
    "arcor.de": "Vodafone Germany Family",
    "vodafone.de": "Vodafone Germany Family",
    "kabelmail.de": "Vodafone Germany Family",
    "alice.de": "O2 Germany Family",
    "orange.fr": "Orange Family",
    "wanadoo.fr": "Orange Family",
    "sfr.fr": "SFR Family",
    "neuf.fr": "SFR Family",
    "club-internet.fr": "SFR Family",
    "free.fr": "Free Family",
    "aliceadsl.fr": "Free Family",
    "laposte.net": "La Poste Family",
    "bbox.fr": "Bouygues Family",
    "numericable.fr": "Numericable Family",
    "libero.it": "Libero Family",
    "virgilio.it": "Virgilio Family",
    "alice.it": "TIM Family",
    "tin.it": "TIM Family",
    ...
    "fastwebnet.it": "Fastweb Family",
    "terra.es": "Terra Family",
    "telefonica.net": "Telefonica Family",
    "movistar.es": "Telefonica Family",
    "ya.com": "Ya.com Family",
    "orange.es": "Orange Spain Family",
    "vodafone.es": "Vodafone Spain Family",
    "ono.com": "Vodafone Spain Family",
    "ziggo.nl": "Ziggo Family",
    "home.nl": "Ziggo Family",
    "kpnmail.nl": "KPN Family",
    "planet.nl": "KPN Family",
    "hetnet.nl": "KPN Family",
    "telenet.be": "Telenet Family",
    "proximus.be": "Proximus Family",
    "skynet.be": "Proximus Family",
    "bluewin.ch": "Swisscom Family",
    "sunrise.ch": "Sunrise Family",
    "aon.at": "A1 Austria Family",
    "chello.at": "Magenta Austria Family",
    "telia.com": "Telia Family",
    "tele2.se": "Tele2 Family",
    "comhem.se": "Tele2 Family",
    "spray.se": "Spray Family",
    "bahnhof.se": "Bahnhof Family",
    "online.no": "Telenor Family",
    "tdc.dk": "TDC Family",
    "yousee.dk": "TDC Family",
    "elisa.fi": "Elisa Family",
    "saunalahti.fi": "Elisa Family",
    
    # Asian ISPs & Regional Giants
    "qq.com": "Tencent Family",
    "foxmail.com": "Tencent Family",
    "163.com": "NetEase Family",
    "126.com": "NetEase Family",
    "yeah.net": "NetEase Family",
    "sina.com": "Sina Family",
    "sina.cn": "Sina Family",
    "vip.sina.com": "Sina Family",
    "sohu.com": "Sohu Family",
    "aliyun.com": "Alibaba Family",
    "tom.com": "TOM Family",
    "139.com": "China Mobile Family",
    "189.cn": "China Telecom Family",
    "wo.cn": "China Unicom Family",
    "docomo.ne.jp": "NTT Docomo Family",
    "softbank.ne.jp": "SoftBank Family",
    "i.softbank.jp": "SoftBank Family",
    "ezweb.ne.jp": "au KDDI Family",
    "au.com": "au KDDI Family",
    "nifty.com": "Nifty Family",
    "ybb.ne.jp": "Yahoo Japan BB Family",
    "plala.or.jp": "Plala Family",
    "ocn.ne.jp": "OCN Family",
    "goo.jp": "Goo Family",
    "biglobe.ne.jp": "Biglobe Family",
    "so-net.ne.jp": "So-net Family",
    "naver.com": "Naver Family",
    "line.me": "Naver Family",
    "daum.net": "Kakao Family",
    "hanmail.net": "Kakao Family",
    "kakao.com": "Kakao Family",
    "nate.com": "Nate Family",
    "korea.com": "Korea.com Family",
    "empas.com": "Empas Family",
    "chol.com": "Chol Family",
    "dreamwiz.com": "DreamWiz Family",
    "rediffmail.com": "Rediffmail Family",
    "sify.com": "Sify Family",
    "indiatimes.com": "IndiaTimes Family",
    "jio.com": "Jio Family",
    "bsnl.in": "BSNL Family",
    "mtnl.net.in": "MTNL Family",
    "msa.hinet.net": "HiNet Taiwan Family",
    "pchome.com.tw": "PChome Taiwan Family",
    "seed.net.tw": "Seednet Taiwan Family",
    "sparqnet.net": "Sparq Taiwan Family",
    "netvigator.com": "Netvigator HK Family",
    "plasa.com": "Telkom Indonesia Family",
    "telkom.net": "Telkom Indonesia Family",    
    "cbn.net.id": "CBN Indonesia Family",
    "centrin.net.id": "Centrin Indonesia Family",
    "indosat.net.id": "Indosat Indonesia Family",
    
    # Australian & New Zealand ISPs
    "bigpond.com": "Telstra Family",
    "bigpond.net.au": "Telstra Family",
    "optusnet.com.au": "Optus Family",
    "tpg.com.au": "TPG Family",
    "iinet.net.au": "iiNet Family",
    "xtra.co.nz": "Spark NZ Family",
    "clear.net.nz": "Vodafone NZ Family",
    ...
    "ig.com.br": "iG Family",
    "globomail.com": "Globo Family",
    "uol.com.ar": "UOL Argentina Family",
    "fibertel.com.ar": "Fibertel Argentina Family",
    "arnet.com.ar": "Telecom Argentina Family",
    "prodigy.net.mx": "Telmex Mexico Family",
    "vtr.net": "VTR Chile Family",
    
    # Middle Eastern & African ISPs
    "walla.co.il": "Walla Israel Family",
    "bezeqint.net": "Bezeq Israel Family",
    "netvision.net.il": "Cellcom Israel Family",
    "mynet.com": "Mynet Turkey Family",
    "ttmail.com": "Turk Telekom Family",
    "mweb.co.za": "MWeb South Africa Family",
    "telkomsa.net": "Telkom South Africa Family",
    "vodamail.co.za": "Vodacom South Africa Family",
    ...
    "protonmail.ch": "Proton Family",
    "pm.me": "Proton Family",
    "tutanota.com": "Tuta Family",
    "tutanota.de": "Tuta Family",
    "tutamail.com": "Tuta Family",
    "tuta.io": "Tuta Family",
    "keemail.me": "Tuta Family",
    "zoho.com": "Zoho Family",
    "zohomail.com": "Zoho Family",
    "zohomail.eu": "Zoho Family",
    "zohomail.in": "Zoho Family",
    "fastmail.com": "Fastmail Family",
    "fastmail.fm": "Fastmail Family",
    "fastmail.co.uk": "Fastmail Family",
    "fastmail.com.au": "Fastmail Family",
    "mailbox.org": "Mailbox.org Family",
    "posteo.de": "Posteo Family",
    "posteo.net": "Posteo Family",
    "runbox.com": "Runbox Family",
    "hushmail.com": "Hushmail Family",
    "startmail.com": "StartMail Family",
    "skiff.com": "Skiff Family",
    ...
    "cheerful.com": "Mail.com Family",
    "programmer.net": "Mail.com Family",
    "musician.org": "Mail.com Family",
    "contractor.net": "Mail.com Family",
    "linuxmail.org": "Mail.com Family",
    "accountant.com": "Mail.com Family",
    "clerk.com": "Mail.com Family",
    "financialservices.com": "Mail.com Family",
    "lawyer.com": "Mail.com Family",
    "realtyagent.com": "Mail.com Family",
    "teachers.org": "Mail.com Family",
    "activist.com": "Mail.com Family",
    "artlover.com": "Mail.com Family",
    "atheist.com": "Mail.com Family",
    "bikerider.com": "Mail.com Family",
    "elvisfan.com": "Mail.com Family",
    "gardener.com": "Mail.com Family",    
}
...
def scan_line(line):
    """
    Extract (domain, email) from a single line.
    Returns (domain, email) or (None, None).
    """
    line = line.strip()
    if not line:
        return None, None

    # Try Email:Password format first (part before colon)
    if ":" in line:
        left_side = line.split(":", 1)[0].strip()
        m = EMAIL_RE.fullmatch(left_side)
        if m:
    ...
    # Fallback: search email anywhere in the line
...
def process_chunk(chunk, emails_by_category, domains_seen, counter, lock):
    """
    Worker: process a chunk of lines.

    emails_by_category : dict  {category: set of emails}
    domains_seen       : set   of domains
    counter            : list  [int] mutable counter
    lock               : threading.Lock
    """
    for line in chunk:
        domain, email = scan_line(line)
        ...
        with lock:
            bucket = emails_by_category.get(category)
            if bucket is None:
                bucket = set()
                emails_by_category[category] = bucket
...
def process_file(filepath, threads, emails_by_category, domains_seen, counter, lock):
...
def write_output(emails_by_category, output_dir):
    """Write one file per category: CategoryName[count].txt (emails only)."""
    if not emails_by_category:
        print(YELLOW + "[!] No emails found. Nothing to write.")
        return

    for category in sorted(emails_by_category.keys()):
        emails = list(emails_by_category[category])
        fname = safe_filename(category) + f"[{len(emails)}].txt"
        ...
        try:
            with open(fpath, "w", encoding="utf-8", newline="\n") as out:
                for email in emails:
                    out.write(email + "\n")
            print(f"{GREEN}[SAVED] {fpath}  ({len(emails)})")
...
def main():
    ...
    # ---------- shared state ----------
    emails_by_category = {}    # {category: set(emails)}
    domains_seen = set()
    counter = [0]              # unique emails count
    lock = Lock()
    ...
    # ---------- write output ----------
    print(YELLOW + "\n[!] Writing output files... (emails only)\n")
    write_output(emails_by_category, output_dir_abs)

    # ---------- summary ----------
    print(GREEN + "\n" + "=" * 50)
    print(GREEN + "  Done.")
    print(YELLOW + f"  Unique emails  : {counter[0]}")
    print(YELLOW + f"  Unique domains : {len(domains_seen)}")
    print(YELLOW + f"  Categories     : {len(emails_by_category)}")
