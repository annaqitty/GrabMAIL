...
mkdir -p "$save" && echo -e "${GREEN}[OK]${NC}" || echo -e "${RED}[ERR]${NC} | ${RED}Directory Already Exists${NC}"
echo ""

# Clean the email list
echo -e "${NC}[+] Total lines: [${LIGHTGREEN}$(wc -l < "$emaillist")${NC}]"
echo "[+] Cleaning your email list, lowering the word in your list, and removing duplicates email. Please wait ..."

awk '{ print tolower($0) }' "$emaillist" | sort -u > "$emaillist.cleaned" && mv "$emaillist.cleaned" "$emaillist"

echo ""
echo "[+] Done ~"
echo ""
echo -e "[+] You have [${LIGHTGREEN}$(wc -l < "$emaillist")${NC}] email(s)"
echo ""
...
filter_and_save() {
  ...
  echo "[+] Filtering $family_name family: "
  ...
  for domain in "${family_list[@]}"; do
    emailtogrep="@$domain."
    grep -F "$emailtogrep" "$emaillist" >> "$save/$file_name"
  done

  # Remove duplicates and sort in one go
  sort -u "$save/$file_name" -o "$save/$file_name"

  local counter=$(wc -l < "$save/$file_name")
...
country_codes=(
  ...
  ["EDU.us"]="Filtered_OTHER_EDU_edu.txt"
  ["ac.uk"]="Filtered_OTHER_EDU_ac.uk.txt"
  ["EDU.ca"]="Filtered_OTHER_EDU_ca.txt"
  ["edu.au"]="Filtered_OTHER_EDU_edu.au.txt"
  ["EDU.de"]="Filtered_OTHER_EDU_de.txt"
  ["EDU.fr"]="Filtered_OTHER_EDU_fr.txt"
  ["ac.jp"]="Filtered_OTHER_EDU_ac.jp.txt"
  ["EDU.kr"]="Filtered_OTHER_EDU_kr.txt"
  ["edu.cn"]="Filtered_OTHER_EDU_edu.cn.txt"
  ["edu.in"]="Filtered_OTHER_EDU_edu.in.txt"
  ["ac.nz"]="Filtered_OTHER_EDU_ac.nz.txt"
  ["edu.sg"]="Filtered_OTHER_EDU_edu.sg.txt"
  ["EDU.ru"]="Filtered_OTHER_EDU_ru.txt"
  ["EDU.it"]="Filtered_OTHER_EDU_it.txt"
  ["EDU.es"]="Filtered_OTHER_EDU_es.txt"
  ["edu.br"]="Filtered_OTHER_EDU_edu.br.txt"
  ["ac.za"]="Filtered_OTHER_EDU_ac.za.txt"
  ["edu.pl"]="Filtered_OTHER_EDU_edu.pl.txt"
  ["edu.tw"]="Filtered_OTHER_EDU_edu.tw.txt"
  ["edu.hk"]="Filtered_OTHER_EDU_edu.hk.txt"
  ["edu.my"]="Filtered_OTHER_EDU_edu.my.txt"
  ["ac.id"]="Filtered_OTHER_EDU_ac.id.txt"
  ["edu.ph"]="Filtered_OTHER_EDU_edu.ph.txt"
  ["edu.vn"]="Filtered_OTHER_EDU_edu.vn.txt"
  ["ac.th"]="Filtered_OTHER_EDU_ac.th.txt"
  ["ac.za"]="Filtered_OTHER_EDU_ac.za.txt"
  ["ac.il"]="Filtered_OTHER_EDU_ac.il.txt"
  ["edu.sa"]="Filtered_OTHER_EDU_edu.sa.txt"
  ["edu.ae"]="Filtered_OTHER_EDU_edu.ae.txt"
  ["edu.kw"]="Filtered_OTHER_EDU_edu.kw.txt"
  ["edu.qa"]="Filtered_OTHER_EDU_edu.qa.txt"
  ["edu.bh"]="Filtered_OTHER_EDU_edu.bh.txt"
  ["edu.om"]="Filtered_OTHER_EDU_edu.om.txt"
  ["edu.jo"]="Filtered_OTHER_EDU_edu.jo.txt"
  ["edu.np"]="Filtered_OTHER_EDU_edu.np.txt"
  ["edu.bd"]="Filtered_OTHER_EDU_edu.bd.txt"
  ["edu.lk"]="Filtered_OTHER_EDU_edu.lk.txt"
  ["edu.pk"]="Filtered_OTHER_EDU_edu.pk.txt"
  ["edu.mn"]="Filtered_OTHER_EDU_edu.mn.txt"
  ["edu.kh"]="Filtered_OTHER_EDU_edu.kh.txt"
  ["edu.la"]="Filtered_OTHER_EDU_edu.la.txt"
  ["edu.mm"]="Filtered_OTHER_EDU_edu.mm.txt"
  ["edu.sg"]="Filtered_OTHER_EDU_edu.sg.txt"
  ["edu.ws"]="Filtered_OTHER_EDU_edu.ws.txt"
  ["edu.fj"]="Filtered_OTHER_EDU_edu.fj.txt"
  ["edu.pg"]="Filtered_OTHER_EDU_edu.pg.txt"
  ["edu.vu"]="Filtered_OTHER_EDU_edu.vu.txt"
  ["edu.tv"]="Filtered_OTHER_EDU_edu.tv.txt"
  ["edu.to"]="Filtered_OTHER_EDU_edu.to.txt"
)
...
regions=(
  ...
  ["SEKOLAH"]="edu school education EDU.us ac.uk EDU.ca edu.au EDU.de EDU.fr ac.jp EDU.kr edu.cn edu.in ac.nz edu.sg EDU.ru EDU.it EDU.es edu.br ac.za edu.pl edu.tw edu.hk edu.my ac.id edu.ph edu.vn ac.th ac.za ac.il edu.sa edu.ae edu.kw edu.qa edu.bh edu.om edu.jo edu.np edu.bd edu.lk edu.pk edu.mn edu.kh edu.la edu.mm edu.sg edu.ws edu.fj edu.pg edu.vu edu.tv edu.to"
